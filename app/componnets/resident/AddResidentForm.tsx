...
const AddResidentForm: React.FC<AddRecordProps> = ({
  isOpen,
  onClose,
  initialTab = "resident",
}) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
      <div className="bg-[#f0f4f8] rounded-2xl w-full max-w-[660px] max-h-[92vh] overflow-y-auto shadow-2xl border border-[#d0e8d4]">

        {/* Header */}
        <div className="px-6 pt-5 pb-4 border-b border-gray-200 bg-white rounded-t-2xl">
          <p className="text-sm font-semibold text-gray-900">Please provide details below!</p>
        </div>
          ...
          {activeTab === "resident" ? (
            <>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <FieldBox>
                  <FieldLabel text="CNIC / NICOP No." green={false} />
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                ...
                <FieldBox>
                  <FieldLabel text="NTN / Tax No." green={false} />
